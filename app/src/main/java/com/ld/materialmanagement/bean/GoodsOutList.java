...
public class GoodsOutList {
    ...
    public OutLibBean ODO;

    public String ODOId;
    public String CurrentBalance;
    public String ADCount;
    public String ODCount;
    public String ODPrice;
    public String ODMoney;
    public String ODMoneyDiffer;
    ...
    public SpannableString showInDialog() {
        ...
        SpannableString sCode = new SpannableString("出库单号: " + ODO.Code + '\n');
        SpannableString sDate = new SpannableString("出库日期: " + StringUtil.formatDateString(ODO.OutDate) + '\n');
        SpannableString sContractCode = new SpannableString("合同编号: " + ODO.ContractCode + '\n');
        SpannableString sCount = new SpannableString("出库数量: " + ODCount + '\n');
        SpannableString sPrice = new SpannableString("出库单价: " + ODPrice + '\n');
        SpannableString sMoney = new SpannableString("出库金额: " + ODMoney + '\n');
